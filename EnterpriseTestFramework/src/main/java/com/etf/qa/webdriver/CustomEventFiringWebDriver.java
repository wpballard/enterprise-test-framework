...
public class CustomEventFiringWebDriver implements WebDriver, JavascriptExecutor, TakesScreenshot,
WrapsDriver, HasInputDevices, HasTouchScreen {
	
	protected final static Logger logger = LoggerFactory.getLogger(CustomEventFiringWebDriver.class);
	...
	private final WebDriver driver;
	   ...
	   */
	  public CustomEventFiringWebDriver register(WebDriverEventListener eventListener) {
	   ...
	   * @return this for method chaining.
	   */
	  public CustomEventFiringWebDriver unregister(WebDriverEventListener eventListener) {
	  ...
	  private class EventFiringWebElement implements WebElement, WrapsElement, WrapsDriver, Locatable {
	    ...
	    public void click() {
	      ...
	      try{
	    	  ...
	    	  logger.info("Stale Element Exception trapped");
	      }
